...
{
    public static class FileIntegrityUtils
    {

        public static string[] CalculateFileIntegrity(FileInfo fi)
        {
            ...
            Task<string> t2 = Crc32Calculate();
            Task.WhenAll(t1, t2);

            return new string[] { t2.Result, t1.Result };
        }
        ...
        public static string GetCrc32Hash(FileInfo file)
        {
